...
const nav: NavItem[] = [
  { label: "Beranda", href: "/dashboard", icon: IconDashboard, active: true },
  { label: "Transaksi", icon: IconReceipt, soon: true },
  { label: "Konsumen", icon: IconUsers, soon: true },
  { label: "Keuangan", icon: IconWallet, soon: true },
  { label: "Laporan", icon: IconChart, soon: true },
  { label: "Pengaturan", icon: IconSettings, soon: true },
];
